...
───────────────────────────────────────────────────────────────────────────── */
const API_ENDPOINT = 'https://eenzakwmmd.execute-api.us-west-2.amazonaws.com/prod/signup';
...
if (form) {
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (API_ENDPOINT === 'https://eenzakwmmd.execute-api.us-west-2.amazonaws.com/prod/signup') {
        if (successEmail) successEmail.textContent = payload.email;
        form.style.display        = 'none';
        formSuccess.style.display = 'block';
      } else {
